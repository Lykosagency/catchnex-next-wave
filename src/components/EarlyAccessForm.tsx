      ...
      <AnimatePresence mode="wait" initial={false}>
        {submitted ? (
          <motion.div
            ...
            className="relative overflow-hidden rounded-2xl border border-gold/30 bg-gradient-to-b from-gold/[0.08] to-transparent backdrop-blur-md p-6 text-center"
            role="status"
            aria-live="polite"
          >
            <motion.div
              ...
              className="mx-auto mb-3 flex size-12 items-center justify-center rounded-full bg-gradient-to-b from-[oklch(0.86_0.10_88)] to-[oklch(0.72_0.13_78)] shadow-lg shadow-gold/30"
            >
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              {duplicate
                ? "We've already saved this email. Stay tuned — launch is coming."
                : "Welcome aboard. We'll reach out as soon as access opens."}
            </p>
          </motion.div>
        ) : (
          <motion.form
